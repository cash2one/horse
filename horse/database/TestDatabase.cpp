/********************************************************************
	created:	2014/03/28
	created:	28:3:2014   10:39
	filename: 	F:\BaiduYunDownload\horse5\horse\database\TestDatabase.cpp
	file path:	F:\BaiduYunDownload\horse5\horse\database
	file base:	TestDatabase
	file ext:	cpp
	author:		clauschen
	
	purpose:	The sample of using database API
*********************************************************************/
