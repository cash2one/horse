...
class MySQL
{
    public:
        ...
        */
        ...
        {
            mysql_thread_init();
            // TC_LOG_WARN(LOG_FILTER_SQL, "Core thread with ID ["UI64FMTD"] initializing MySQL thread.",                (uint64)ACE_Based::Thread::currentId());
        }
        ...
        */
        ...
        {
            mysql_thread_end();
            // TC_LOG_WARN(LOG_FILTER_SQL, "Core thread with ID ["UI64FMTD"] shutting down MySQL thread.",                (uint64)ACE_Based::Thread::currentId());
        }
