...
class MySQLConnection
{
    ...
    public:
        ...
        MySQLConnection(boost::lockfree::queue<SQLOperation*>* queue, MySQLConnectionInfo& connInfo);  //! Constructor for asynchronous connections.
...
//             m_Mutex.release();
    ...
    private:
        boost::lockfree::queue<SQLOperation*>*	m_queue;                      //! Queue shared with other asynchronous connections.
